 ...
 *         </pre>
 */
public class WecahtPayUtil {
    protected final Log LOG = LogFactory.getLog(WecahtPayUtil.class);
     ...
     */
    public WecahtPayUtil(PayConfigStorage payConfigStorage) {
     ...
     */
    public WecahtPayUtil(PayConfigStorage payConfigStorage, HttpConfigStorage configStorage) {
